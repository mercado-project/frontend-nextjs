              ...
              <div className="flex items-center gap-5">
                {!isLogged ? (
                  ...
                  <div className="relative group">
                    ...
                    {/* Dropdown */}
                    <div className="absolute mt-2 w-40 bg-white border border-gray-3 rounded-md shadow-lg opacity-0 invisible group-hover:opacity-100 group-hover:visible transition-all duration-200 z-50">
                      <Link
                        href="/perfil"
